...
lyr_BM86ANZwaypoints_3.set('fieldAliases', {'ele': 'ele', 'time': 'time', 'magvar': 'magvar', 'geoidheight': 'geoidheight', 'name': 'name', 'cmt': 'cmt', 'desc': 'desc', 'src': 'src', 'url': 'url', 'urlname': 'urlname', 'sym': 'sym', 'type': 'type', 'fix': 'fix', 'sat': 'sat', 'hdop': 'hdop', 'vdop': 'vdop', 'pdop': 'pdop', 'ageofdgpsdata': 'ageofdgpsdata', 'dgpsid': 'dgpsid', 'wanhatkunnat_120321_field_1': 'wanhatkunnat_120321_field_1', });
...
lyr_BM86ANZwaypoints_3.set('fieldImages', {'ele': 'Hidden', 'time': 'Hidden', 'magvar': 'Hidden', 'geoidheight': 'Hidden', 'name': 'Hidden', 'cmt': 'Hidden', 'desc': 'Hidden', 'src': 'Hidden', 'url': 'Hidden', 'urlname': 'Hidden', 'sym': 'Hidden', 'type': 'Hidden', 'fix': 'Hidden', 'sat': 'Hidden', 'hdop': 'Hidden', 'vdop': 'Hidden', 'pdop': 'Hidden', 'ageofdgpsdata': 'Hidden', 'dgpsid': 'Hidden', 'wanhatkunnat_120321_field_1': 'TextEdit', });
lyr_BM86ANZ_loydettywaypoints_4.set('fieldImages', {'ele': 'Hidden', 'time': 'Hidden', 'magvar': 'Hidden', 'geoidheight': 'Hidden', 'name': 'TextEdit', 'cmt': 'Hidden', 'desc': 'Hidden', 'src': 'Hidden', 'url': 'Hidden', 'urlname': 'TextEdit', 'sym': 'Hidden', 'type': 'Hidden', 'fix': 'Hidden', 'sat': 'Hidden', 'hdop': 'Hidden', 'vdop': 'Hidden', 'pdop': 'Hidden', 'ageofdgpsdata': 'Hidden', 'dgpsid': 'Hidden', 'wanhatkunnat_120321_field_1': 'TextEdit', });
lyr_SuomenKuntajako_2021_4500k_1.set('fieldLabels', {'NAMEFIN': 'no label', });
lyr_SuomenMaakuntajako_2021_4500k_2.set('fieldLabels', {});
lyr_BM86ANZwaypoints_3.set('fieldLabels', {'wanhatkunnat_120321_field_1': 'no label', });
lyr_BM86ANZ_loydettywaypoints_4.set('fieldLabels', {'name': 'no label', 'urlname': 'no label', 'wanhatkunnat_120321_field_1': 'no label', });
