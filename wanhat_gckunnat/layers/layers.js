...
document.getElementById('tilanne_meter').innerHTML = "<label for='tilanne'>Löydettyjen kuntien tilanne (georapo):<label>  <meter id='tilanne' value='" + loydetyt_kpl + "' min='0' max='" + yhteensa + "'></meter><font color='green'>  " + loydetyt_kpl.toString() + "</font><font color='grey'> / " + yhteensa.toString() + "</font>";
